...
export const EloLogFindFirstOrThrowSelectSchema: z.ZodType<Prisma.EloLogSelect> = z.object({
...
export const EloLogFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    opponent_id: z.boolean().optional(),
    cube_type: z.boolean().optional(),
    elo_change: z.boolean().optional(),
...
export const EloLogFindFirstOrThrowSchema: z.ZodType<Prisma.EloLogFindFirstOrThrowArgs> = z.object({ select: EloLogFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => EloLogIncludeObjectSchema.optional()), orderBy: z.union([EloLogOrderByWithRelationInputObjectSchema, EloLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: EloLogWhereInputObjectSchema.optional(), cursor: EloLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EloLogScalarFieldEnumSchema, EloLogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.EloLogFindFirstOrThrowArgs>;

export const EloLogFindFirstOrThrowZodSchema = z.object({ select: EloLogFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => EloLogIncludeObjectSchema.optional()), orderBy: z.union([EloLogOrderByWithRelationInputObjectSchema, EloLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: EloLogWhereInputObjectSchema.optional(), cursor: EloLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EloLogScalarFieldEnumSchema, EloLogScalarFieldEnumSchema.array()]).optional() }).strict();