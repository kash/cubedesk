...
export const SolveMethodStepFindManySelectSchema: z.ZodType<Prisma.SolveMethodStepSelect> = z.object({
...
export const SolveMethodStepFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    solve_id: z.boolean().optional(),
    turn_count: z.boolean().optional(),
    turns: z.boolean().optional(),
...
export const SolveMethodStepFindManySchema: z.ZodType<Prisma.SolveMethodStepFindManyArgs> = z.object({ select: SolveMethodStepFindManySelectSchema.optional(), include: z.lazy(() => SolveMethodStepIncludeObjectSchema.optional()), orderBy: z.union([SolveMethodStepOrderByWithRelationInputObjectSchema, SolveMethodStepOrderByWithRelationInputObjectSchema.array()]).optional(), where: SolveMethodStepWhereInputObjectSchema.optional(), cursor: SolveMethodStepWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SolveMethodStepScalarFieldEnumSchema, SolveMethodStepScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.SolveMethodStepFindManyArgs>;

export const SolveMethodStepFindManyZodSchema = z.object({ select: SolveMethodStepFindManySelectSchema.optional(), include: z.lazy(() => SolveMethodStepIncludeObjectSchema.optional()), orderBy: z.union([SolveMethodStepOrderByWithRelationInputObjectSchema, SolveMethodStepOrderByWithRelationInputObjectSchema.array()]).optional(), where: SolveMethodStepWhereInputObjectSchema.optional(), cursor: SolveMethodStepWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SolveMethodStepScalarFieldEnumSchema, SolveMethodStepScalarFieldEnumSchema.array()]).optional() }).strict();