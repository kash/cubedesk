...
export const MatchLobbyFindFirstOrThrowSelectSchema: z.ZodType<Prisma.MatchLobbySelect> = z.object({
...
export const MatchLobbyFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    user_id: z.boolean().optional(),
    cube_type: z.boolean().optional(),
    game_type: z.boolean().optional(),
...
export const MatchLobbyFindFirstOrThrowSchema: z.ZodType<Prisma.MatchLobbyFindFirstOrThrowArgs> = z.object({ select: MatchLobbyFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => MatchLobbyIncludeObjectSchema.optional()), orderBy: z.union([MatchLobbyOrderByWithRelationInputObjectSchema, MatchLobbyOrderByWithRelationInputObjectSchema.array()]).optional(), where: MatchLobbyWhereInputObjectSchema.optional(), cursor: MatchLobbyWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MatchLobbyScalarFieldEnumSchema, MatchLobbyScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.MatchLobbyFindFirstOrThrowArgs>;

export const MatchLobbyFindFirstOrThrowZodSchema = z.object({ select: MatchLobbyFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => MatchLobbyIncludeObjectSchema.optional()), orderBy: z.union([MatchLobbyOrderByWithRelationInputObjectSchema, MatchLobbyOrderByWithRelationInputObjectSchema.array()]).optional(), where: MatchLobbyWhereInputObjectSchema.optional(), cursor: MatchLobbyWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MatchLobbyScalarFieldEnumSchema, MatchLobbyScalarFieldEnumSchema.array()]).optional() }).strict();