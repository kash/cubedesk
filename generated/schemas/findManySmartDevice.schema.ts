...
export const SmartDeviceFindManySelectSchema: z.ZodType<Prisma.SmartDeviceSelect> = z.object({
...
export const SmartDeviceFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    internal_name: z.boolean().optional(),
    created_at: z.boolean().optional(),
...
export const SmartDeviceFindManySchema: z.ZodType<Prisma.SmartDeviceFindManyArgs> = z.object({ select: SmartDeviceFindManySelectSchema.optional(), include: z.lazy(() => SmartDeviceIncludeObjectSchema.optional()), orderBy: z.union([SmartDeviceOrderByWithRelationInputObjectSchema, SmartDeviceOrderByWithRelationInputObjectSchema.array()]).optional(), where: SmartDeviceWhereInputObjectSchema.optional(), cursor: SmartDeviceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SmartDeviceScalarFieldEnumSchema, SmartDeviceScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.SmartDeviceFindManyArgs>;

export const SmartDeviceFindManyZodSchema = z.object({ select: SmartDeviceFindManySelectSchema.optional(), include: z.lazy(() => SmartDeviceIncludeObjectSchema.optional()), orderBy: z.union([SmartDeviceOrderByWithRelationInputObjectSchema, SmartDeviceOrderByWithRelationInputObjectSchema.array()]).optional(), where: SmartDeviceWhereInputObjectSchema.optional(), cursor: SmartDeviceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SmartDeviceScalarFieldEnumSchema, SmartDeviceScalarFieldEnumSchema.array()]).optional() }).strict();