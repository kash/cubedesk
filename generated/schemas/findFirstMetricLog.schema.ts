...
export const MetricLogFindFirstSelectSchema: z.ZodType<Prisma.MetricLogSelect> = z.object({
...
export const MetricLogFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    user_email: z.boolean().optional(),
    metric_type: z.boolean().optional(),
    metric_value: z.boolean().optional(),
...
export const MetricLogFindFirstSchema: z.ZodType<Prisma.MetricLogFindFirstArgs> = z.object({ select: MetricLogFindFirstSelectSchema.optional(), include: z.lazy(() => MetricLogIncludeObjectSchema.optional()), orderBy: z.union([MetricLogOrderByWithRelationInputObjectSchema, MetricLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: MetricLogWhereInputObjectSchema.optional(), cursor: MetricLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MetricLogScalarFieldEnumSchema, MetricLogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.MetricLogFindFirstArgs>;

export const MetricLogFindFirstZodSchema = z.object({ select: MetricLogFindFirstSelectSchema.optional(), include: z.lazy(() => MetricLogIncludeObjectSchema.optional()), orderBy: z.union([MetricLogOrderByWithRelationInputObjectSchema, MetricLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: MetricLogWhereInputObjectSchema.optional(), cursor: MetricLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MetricLogScalarFieldEnumSchema, MetricLogScalarFieldEnumSchema.array()]).optional() }).strict();