...
export const GameSessionFindManySelectSchema: z.ZodType<Prisma.GameSessionSelect> = z.object({
...
export const GameSessionFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    user_id: z.boolean().optional(),
    match_id: z.boolean().optional(),
    game_type: z.boolean().optional(),
...
export const GameSessionFindManySchema: z.ZodType<Prisma.GameSessionFindManyArgs> = z.object({ select: GameSessionFindManySelectSchema.optional(), include: z.lazy(() => GameSessionIncludeObjectSchema.optional()), orderBy: z.union([GameSessionOrderByWithRelationInputObjectSchema, GameSessionOrderByWithRelationInputObjectSchema.array()]).optional(), where: GameSessionWhereInputObjectSchema.optional(), cursor: GameSessionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([GameSessionScalarFieldEnumSchema, GameSessionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.GameSessionFindManyArgs>;

export const GameSessionFindManyZodSchema = z.object({ select: GameSessionFindManySelectSchema.optional(), include: z.lazy(() => GameSessionIncludeObjectSchema.optional()), orderBy: z.union([GameSessionOrderByWithRelationInputObjectSchema, GameSessionOrderByWithRelationInputObjectSchema.array()]).optional(), where: GameSessionWhereInputObjectSchema.optional(), cursor: GameSessionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([GameSessionScalarFieldEnumSchema, GameSessionScalarFieldEnumSchema.array()]).optional() }).strict();