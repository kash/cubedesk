...
export const CustomTrainerLikeFindManySelectSchema: z.ZodType<Prisma.CustomTrainerLikeSelect> = z.object({
...
export const CustomTrainerLikeFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    custom_trainer_id: z.boolean().optional(),
    user_id: z.boolean().optional(),
    created_at: z.boolean().optional(),
...
export const CustomTrainerLikeFindManySchema: z.ZodType<Prisma.CustomTrainerLikeFindManyArgs> = z.object({ select: CustomTrainerLikeFindManySelectSchema.optional(), include: z.lazy(() => CustomTrainerLikeIncludeObjectSchema.optional()), orderBy: z.union([CustomTrainerLikeOrderByWithRelationInputObjectSchema, CustomTrainerLikeOrderByWithRelationInputObjectSchema.array()]).optional(), where: CustomTrainerLikeWhereInputObjectSchema.optional(), cursor: CustomTrainerLikeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CustomTrainerLikeScalarFieldEnumSchema, CustomTrainerLikeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CustomTrainerLikeFindManyArgs>;

export const CustomTrainerLikeFindManyZodSchema = z.object({ select: CustomTrainerLikeFindManySelectSchema.optional(), include: z.lazy(() => CustomTrainerLikeIncludeObjectSchema.optional()), orderBy: z.union([CustomTrainerLikeOrderByWithRelationInputObjectSchema, CustomTrainerLikeOrderByWithRelationInputObjectSchema.array()]).optional(), where: CustomTrainerLikeWhereInputObjectSchema.optional(), cursor: CustomTrainerLikeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CustomTrainerLikeScalarFieldEnumSchema, CustomTrainerLikeScalarFieldEnumSchema.array()]).optional() }).strict();