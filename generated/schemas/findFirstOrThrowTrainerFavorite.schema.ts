...
export const TrainerFavoriteFindFirstOrThrowSelectSchema: z.ZodType<Prisma.TrainerFavoriteSelect> = z.object({
...
export const TrainerFavoriteFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    cube_key: z.boolean().optional(),
    user_id: z.boolean().optional(),
    created_at: z.boolean().optional(),
