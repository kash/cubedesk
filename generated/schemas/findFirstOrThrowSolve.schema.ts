...
export const SolveFindFirstOrThrowSelectSchema: z.ZodType<Prisma.SolveSelect> = z.object({
...
export const SolveFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    user_id: z.boolean().optional(),
    time: z.boolean().optional(),
    raw_time: z.boolean().optional(),
...
export const SolveFindFirstOrThrowSchema: z.ZodType<Prisma.SolveFindFirstOrThrowArgs> = z.object({ select: SolveFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => SolveIncludeObjectSchema.optional()), orderBy: z.union([SolveOrderByWithRelationInputObjectSchema, SolveOrderByWithRelationInputObjectSchema.array()]).optional(), where: SolveWhereInputObjectSchema.optional(), cursor: SolveWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SolveScalarFieldEnumSchema, SolveScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.SolveFindFirstOrThrowArgs>;

export const SolveFindFirstOrThrowZodSchema = z.object({ select: SolveFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => SolveIncludeObjectSchema.optional()), orderBy: z.union([SolveOrderByWithRelationInputObjectSchema, SolveOrderByWithRelationInputObjectSchema.array()]).optional(), where: SolveWhereInputObjectSchema.optional(), cursor: SolveWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SolveScalarFieldEnumSchema, SolveScalarFieldEnumSchema.array()]).optional() }).strict();