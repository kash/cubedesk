...
export const MatchParticipantFindFirstOrThrowSelectSchema: z.ZodType<Prisma.MatchParticipantSelect> = z.object({
...
export const MatchParticipantFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    match_id: z.boolean().optional(),
    user_id: z.boolean().optional(),
    created_at: z.boolean().optional(),
