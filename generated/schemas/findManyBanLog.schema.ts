...
export const BanLogFindManySelectSchema: z.ZodType<Prisma.BanLogSelect> = z.object({
...
export const BanLogFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    created_by_id: z.boolean().optional(),
    banned_user_id: z.boolean().optional(),
    reason: z.boolean().optional(),
