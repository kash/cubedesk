...
export const MatchFindFirstSelectSchema: z.ZodType<Prisma.MatchSelect> = z.object({
...
export const MatchFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    winner_id: z.boolean().optional(),
    created_at: z.boolean().optional(),
    link_code: z.boolean().optional(),
...
export const MatchFindFirstSchema: z.ZodType<Prisma.MatchFindFirstArgs> = z.object({ select: MatchFindFirstSelectSchema.optional(), include: z.lazy(() => MatchIncludeObjectSchema.optional()), orderBy: z.union([MatchOrderByWithRelationInputObjectSchema, MatchOrderByWithRelationInputObjectSchema.array()]).optional(), where: MatchWhereInputObjectSchema.optional(), cursor: MatchWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MatchScalarFieldEnumSchema, MatchScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.MatchFindFirstArgs>;

export const MatchFindFirstZodSchema = z.object({ select: MatchFindFirstSelectSchema.optional(), include: z.lazy(() => MatchIncludeObjectSchema.optional()), orderBy: z.union([MatchOrderByWithRelationInputObjectSchema, MatchOrderByWithRelationInputObjectSchema.array()]).optional(), where: MatchWhereInputObjectSchema.optional(), cursor: MatchWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MatchScalarFieldEnumSchema, MatchScalarFieldEnumSchema.array()]).optional() }).strict();