...
export const EloRatingFindManySelectSchema: z.ZodType<Prisma.EloRatingSelect> = z.object({
...
export const EloRatingFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    user_id: z.boolean().optional(),
    elo_222_rating: z.boolean().optional(),
    elo_333_rating: z.boolean().optional(),
