...
export const ProfileGroupByResultSchema = z.array(z.object({
  id: z.string(),
  user_id: z.string(),
  header_image_id: z.string(),
  pfp_image_id: z.string(),
  created_at: z.date(),
  bio: z.string(),
  favorite_event: z.string(),
  main_three_cube: z.string(),
  three_goal: z.string(),
  three_method: z.string(),
  reddit_link: z.string(),
  twitch_link: z.string(),
