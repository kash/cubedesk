...
export const NotificationPreferenceFindFirstSelectSchema: z.ZodType<Prisma.NotificationPreferenceSelect> = z.object({
...
export const NotificationPreferenceFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    user_id: z.boolean().optional(),
    friend_request: z.boolean().optional(),
    friend_request_accept: z.boolean().optional(),
...
export const NotificationPreferenceFindFirstSchema: z.ZodType<Prisma.NotificationPreferenceFindFirstArgs> = z.object({ select: NotificationPreferenceFindFirstSelectSchema.optional(), include: z.lazy(() => NotificationPreferenceIncludeObjectSchema.optional()), orderBy: z.union([NotificationPreferenceOrderByWithRelationInputObjectSchema, NotificationPreferenceOrderByWithRelationInputObjectSchema.array()]).optional(), where: NotificationPreferenceWhereInputObjectSchema.optional(), cursor: NotificationPreferenceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([NotificationPreferenceScalarFieldEnumSchema, NotificationPreferenceScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.NotificationPreferenceFindFirstArgs>;

export const NotificationPreferenceFindFirstZodSchema = z.object({ select: NotificationPreferenceFindFirstSelectSchema.optional(), include: z.lazy(() => NotificationPreferenceIncludeObjectSchema.optional()), orderBy: z.union([NotificationPreferenceOrderByWithRelationInputObjectSchema, NotificationPreferenceOrderByWithRelationInputObjectSchema.array()]).optional(), where: NotificationPreferenceWhereInputObjectSchema.optional(), cursor: NotificationPreferenceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([NotificationPreferenceScalarFieldEnumSchema, NotificationPreferenceScalarFieldEnumSchema.array()]).optional() }).strict();