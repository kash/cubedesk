...
export const CustomCubeTypeFindFirstSelectSchema: z.ZodType<Prisma.CustomCubeTypeSelect> = z.object({
...
export const CustomCubeTypeFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    user_id: z.boolean().optional(),
    name: z.boolean().optional(),
    created_at: z.boolean().optional(),
...
export const CustomCubeTypeFindFirstSchema: z.ZodType<Prisma.CustomCubeTypeFindFirstArgs> = z.object({ select: CustomCubeTypeFindFirstSelectSchema.optional(), include: z.lazy(() => CustomCubeTypeIncludeObjectSchema.optional()), orderBy: z.union([CustomCubeTypeOrderByWithRelationInputObjectSchema, CustomCubeTypeOrderByWithRelationInputObjectSchema.array()]).optional(), where: CustomCubeTypeWhereInputObjectSchema.optional(), cursor: CustomCubeTypeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CustomCubeTypeScalarFieldEnumSchema, CustomCubeTypeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CustomCubeTypeFindFirstArgs>;

export const CustomCubeTypeFindFirstZodSchema = z.object({ select: CustomCubeTypeFindFirstSelectSchema.optional(), include: z.lazy(() => CustomCubeTypeIncludeObjectSchema.optional()), orderBy: z.union([CustomCubeTypeOrderByWithRelationInputObjectSchema, CustomCubeTypeOrderByWithRelationInputObjectSchema.array()]).optional(), where: CustomCubeTypeWhereInputObjectSchema.optional(), cursor: CustomCubeTypeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CustomCubeTypeScalarFieldEnumSchema, CustomCubeTypeScalarFieldEnumSchema.array()]).optional() }).strict();