...
export const SolveMethodStepFindFirstOrThrowSelectSchema: z.ZodType<Prisma.SolveMethodStepSelect> = z.object({
...
export const SolveMethodStepFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    solve_id: z.boolean().optional(),
    turn_count: z.boolean().optional(),
    turns: z.boolean().optional(),
...
export const SolveMethodStepFindFirstOrThrowSchema: z.ZodType<Prisma.SolveMethodStepFindFirstOrThrowArgs> = z.object({ select: SolveMethodStepFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => SolveMethodStepIncludeObjectSchema.optional()), orderBy: z.union([SolveMethodStepOrderByWithRelationInputObjectSchema, SolveMethodStepOrderByWithRelationInputObjectSchema.array()]).optional(), where: SolveMethodStepWhereInputObjectSchema.optional(), cursor: SolveMethodStepWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SolveMethodStepScalarFieldEnumSchema, SolveMethodStepScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.SolveMethodStepFindFirstOrThrowArgs>;

export const SolveMethodStepFindFirstOrThrowZodSchema = z.object({ select: SolveMethodStepFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => SolveMethodStepIncludeObjectSchema.optional()), orderBy: z.union([SolveMethodStepOrderByWithRelationInputObjectSchema, SolveMethodStepOrderByWithRelationInputObjectSchema.array()]).optional(), where: SolveMethodStepWhereInputObjectSchema.optional(), cursor: SolveMethodStepWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SolveMethodStepScalarFieldEnumSchema, SolveMethodStepScalarFieldEnumSchema.array()]).optional() }).strict();