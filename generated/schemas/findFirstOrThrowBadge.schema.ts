...
export const BadgeFindFirstOrThrowSelectSchema: z.ZodType<Prisma.BadgeSelect> = z.object({
...
export const BadgeFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    user_id: z.boolean().optional(),
    badge_type_id: z.boolean().optional(),
    created_at: z.boolean().optional(),
...
export const BadgeFindFirstOrThrowSchema: z.ZodType<Prisma.BadgeFindFirstOrThrowArgs> = z.object({ select: BadgeFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => BadgeIncludeObjectSchema.optional()), orderBy: z.union([BadgeOrderByWithRelationInputObjectSchema, BadgeOrderByWithRelationInputObjectSchema.array()]).optional(), where: BadgeWhereInputObjectSchema.optional(), cursor: BadgeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BadgeScalarFieldEnumSchema, BadgeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.BadgeFindFirstOrThrowArgs>;

export const BadgeFindFirstOrThrowZodSchema = z.object({ select: BadgeFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => BadgeIncludeObjectSchema.optional()), orderBy: z.union([BadgeOrderByWithRelationInputObjectSchema, BadgeOrderByWithRelationInputObjectSchema.array()]).optional(), where: BadgeWhereInputObjectSchema.optional(), cursor: BadgeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BadgeScalarFieldEnumSchema, BadgeScalarFieldEnumSchema.array()]).optional() }).strict();