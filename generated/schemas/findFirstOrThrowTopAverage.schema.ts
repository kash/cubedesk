...
export const TopAverageFindFirstOrThrowSelectSchema: z.ZodType<Prisma.TopAverageSelect> = z.object({
...
export const TopAverageFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    user_id: z.boolean().optional(),
    time: z.boolean().optional(),
    cube_type: z.boolean().optional(),
...
export const TopAverageFindFirstOrThrowSchema: z.ZodType<Prisma.TopAverageFindFirstOrThrowArgs> = z.object({ select: TopAverageFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => TopAverageIncludeObjectSchema.optional()), orderBy: z.union([TopAverageOrderByWithRelationInputObjectSchema, TopAverageOrderByWithRelationInputObjectSchema.array()]).optional(), where: TopAverageWhereInputObjectSchema.optional(), cursor: TopAverageWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TopAverageScalarFieldEnumSchema, TopAverageScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TopAverageFindFirstOrThrowArgs>;

export const TopAverageFindFirstOrThrowZodSchema = z.object({ select: TopAverageFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => TopAverageIncludeObjectSchema.optional()), orderBy: z.union([TopAverageOrderByWithRelationInputObjectSchema, TopAverageOrderByWithRelationInputObjectSchema.array()]).optional(), where: TopAverageWhereInputObjectSchema.optional(), cursor: TopAverageWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TopAverageScalarFieldEnumSchema, TopAverageScalarFieldEnumSchema.array()]).optional() }).strict();