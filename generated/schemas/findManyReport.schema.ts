...
export const ReportFindManySelectSchema: z.ZodType<Prisma.ReportSelect> = z.object({
...
export const ReportFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    created_at: z.boolean().optional(),
    reason: z.boolean().optional(),
    created_by_id: z.boolean().optional(),
...
export const ReportFindManySchema: z.ZodType<Prisma.ReportFindManyArgs> = z.object({ select: ReportFindManySelectSchema.optional(), include: z.lazy(() => ReportIncludeObjectSchema.optional()), orderBy: z.union([ReportOrderByWithRelationInputObjectSchema, ReportOrderByWithRelationInputObjectSchema.array()]).optional(), where: ReportWhereInputObjectSchema.optional(), cursor: ReportWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ReportScalarFieldEnumSchema, ReportScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ReportFindManyArgs>;

export const ReportFindManyZodSchema = z.object({ select: ReportFindManySelectSchema.optional(), include: z.lazy(() => ReportIncludeObjectSchema.optional()), orderBy: z.union([ReportOrderByWithRelationInputObjectSchema, ReportOrderByWithRelationInputObjectSchema.array()]).optional(), where: ReportWhereInputObjectSchema.optional(), cursor: ReportWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ReportScalarFieldEnumSchema, ReportScalarFieldEnumSchema.array()]).optional() }).strict();