...
export const MetricLogFindFirstOrThrowSelectSchema: z.ZodType<Prisma.MetricLogSelect> = z.object({
...
export const MetricLogFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    user_email: z.boolean().optional(),
    metric_type: z.boolean().optional(),
    metric_value: z.boolean().optional(),
...
export const MetricLogFindFirstOrThrowSchema: z.ZodType<Prisma.MetricLogFindFirstOrThrowArgs> = z.object({ select: MetricLogFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => MetricLogIncludeObjectSchema.optional()), orderBy: z.union([MetricLogOrderByWithRelationInputObjectSchema, MetricLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: MetricLogWhereInputObjectSchema.optional(), cursor: MetricLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MetricLogScalarFieldEnumSchema, MetricLogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.MetricLogFindFirstOrThrowArgs>;

export const MetricLogFindFirstOrThrowZodSchema = z.object({ select: MetricLogFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => MetricLogIncludeObjectSchema.optional()), orderBy: z.union([MetricLogOrderByWithRelationInputObjectSchema, MetricLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: MetricLogWhereInputObjectSchema.optional(), cursor: MetricLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MetricLogScalarFieldEnumSchema, MetricLogScalarFieldEnumSchema.array()]).optional() }).strict();