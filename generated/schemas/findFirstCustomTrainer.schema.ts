...
export const CustomTrainerFindFirstSelectSchema: z.ZodType<Prisma.CustomTrainerSelect> = z.object({
...
export const CustomTrainerFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    colors: z.boolean().optional(),
    cube_type: z.boolean().optional(),
    key: z.boolean().optional(),
...
export const CustomTrainerFindFirstSchema: z.ZodType<Prisma.CustomTrainerFindFirstArgs> = z.object({ select: CustomTrainerFindFirstSelectSchema.optional(), include: z.lazy(() => CustomTrainerIncludeObjectSchema.optional()), orderBy: z.union([CustomTrainerOrderByWithRelationInputObjectSchema, CustomTrainerOrderByWithRelationInputObjectSchema.array()]).optional(), where: CustomTrainerWhereInputObjectSchema.optional(), cursor: CustomTrainerWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CustomTrainerScalarFieldEnumSchema, CustomTrainerScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CustomTrainerFindFirstArgs>;

export const CustomTrainerFindFirstZodSchema = z.object({ select: CustomTrainerFindFirstSelectSchema.optional(), include: z.lazy(() => CustomTrainerIncludeObjectSchema.optional()), orderBy: z.union([CustomTrainerOrderByWithRelationInputObjectSchema, CustomTrainerOrderByWithRelationInputObjectSchema.array()]).optional(), where: CustomTrainerWhereInputObjectSchema.optional(), cursor: CustomTrainerWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CustomTrainerScalarFieldEnumSchema, CustomTrainerScalarFieldEnumSchema.array()]).optional() }).strict();