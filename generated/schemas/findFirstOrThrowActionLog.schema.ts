...
export const ActionLogFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ActionLogSelect> = z.object({
...
export const ActionLogFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    user_email: z.boolean().optional(),
    action_type: z.boolean().optional(),
    action_details: z.boolean().optional(),
