...
export const UserAccountCountOutputTypeCountCustomTrainerArgsObjectSchema = makeSchema();
export const UserAccountCountOutputTypeCountCustomTrainerArgsObjectZodSchema = makeSchema();
