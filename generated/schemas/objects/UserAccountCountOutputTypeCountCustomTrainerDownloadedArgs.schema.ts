...
export const UserAccountCountOutputTypeCountCustomTrainerDownloadedArgsObjectSchema = makeSchema();
export const UserAccountCountOutputTypeCountCustomTrainerDownloadedArgsObjectZodSchema = makeSchema();
