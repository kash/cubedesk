...
export const CustomTrainerCountOutputTypeCountLikesArgsObjectSchema = makeSchema();
export const CustomTrainerCountOutputTypeCountLikesArgsObjectZodSchema = makeSchema();
