...
import { UserAccountUpdateOneWithoutNotifications_triggeredNestedInputObjectSchema as UserAccountUpdateOneWithoutNotifications_triggeredNestedInputObjectSchema } from './UserAccountUpdateOneWithoutNotifications_triggeredNestedInput.schema';
import { UserAccountUpdateOneRequiredWithoutNotificationsNestedInputObjectSchema as UserAccountUpdateOneRequiredWithoutNotificationsNestedInputObjectSchema } from './UserAccountUpdateOneRequiredWithoutNotificationsNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  triggering_user: z.lazy(() => UserAccountUpdateOneWithoutNotifications_triggeredNestedInputObjectSchema).optional(),
  user: z.lazy(() => UserAccountUpdateOneRequiredWithoutNotificationsNestedInputObjectSchema).optional()
}).strict();
