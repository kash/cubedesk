...
export const MatchCountOutputTypeCountParticipantsArgsObjectSchema = makeSchema();
export const MatchCountOutputTypeCountParticipantsArgsObjectZodSchema = makeSchema();
