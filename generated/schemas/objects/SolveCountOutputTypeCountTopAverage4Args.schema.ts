...
export const SolveCountOutputTypeCountTopAverage4ArgsObjectSchema = makeSchema();
export const SolveCountOutputTypeCountTopAverage4ArgsObjectZodSchema = makeSchema();
