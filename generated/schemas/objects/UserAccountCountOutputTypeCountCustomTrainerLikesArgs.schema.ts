...
export const UserAccountCountOutputTypeCountCustomTrainerLikesArgsObjectSchema = makeSchema();
export const UserAccountCountOutputTypeCountCustomTrainerLikesArgsObjectZodSchema = makeSchema();
