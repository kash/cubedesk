...
export const SolveCountOutputTypeCountTopAverage3ArgsObjectSchema = makeSchema();
export const SolveCountOutputTypeCountTopAverage3ArgsObjectZodSchema = makeSchema();
