...
const elologwhereinputSchema = z.object({
  AND: z.union([z.lazy(() => EloLogWhereInputObjectSchema), z.lazy(() => EloLogWhereInputObjectSchema).array()]).optional(),
  OR: z.lazy(() => EloLogWhereInputObjectSchema).array().optional(),
  NOT: z.union([z.lazy(() => EloLogWhereInputObjectSchema), z.lazy(() => EloLogWhereInputObjectSchema).array()]).optional(),
  ...
  opponent: z.union([z.lazy(() => UserAccountNullableScalarRelationFilterObjectSchema), z.lazy(() => UserAccountWhereInputObjectSchema)]).optional(),
  player: z.union([z.lazy(() => UserAccountScalarRelationFilterObjectSchema), z.lazy(() => UserAccountWhereInputObjectSchema)]).optional()
}).strict();
export const EloLogWhereInputObjectSchema: z.ZodType<Prisma.EloLogWhereInput> = elologwhereinputSchema as unknown as z.ZodType<Prisma.EloLogWhereInput>;
export const EloLogWhereInputObjectZodSchema = elologwhereinputSchema;
