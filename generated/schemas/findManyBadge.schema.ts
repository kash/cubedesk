...
export const BadgeFindManySelectSchema: z.ZodType<Prisma.BadgeSelect> = z.object({
...
export const BadgeFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    user_id: z.boolean().optional(),
    badge_type_id: z.boolean().optional(),
    created_at: z.boolean().optional(),
