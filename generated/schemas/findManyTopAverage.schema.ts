...
export const TopAverageFindManySelectSchema: z.ZodType<Prisma.TopAverageSelect> = z.object({
...
export const TopAverageFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    user_id: z.boolean().optional(),
    time: z.boolean().optional(),
    cube_type: z.boolean().optional(),
...
export const TopAverageFindManySchema: z.ZodType<Prisma.TopAverageFindManyArgs> = z.object({ select: TopAverageFindManySelectSchema.optional(), include: z.lazy(() => TopAverageIncludeObjectSchema.optional()), orderBy: z.union([TopAverageOrderByWithRelationInputObjectSchema, TopAverageOrderByWithRelationInputObjectSchema.array()]).optional(), where: TopAverageWhereInputObjectSchema.optional(), cursor: TopAverageWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TopAverageScalarFieldEnumSchema, TopAverageScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TopAverageFindManyArgs>;

export const TopAverageFindManyZodSchema = z.object({ select: TopAverageFindManySelectSchema.optional(), include: z.lazy(() => TopAverageIncludeObjectSchema.optional()), orderBy: z.union([TopAverageOrderByWithRelationInputObjectSchema, TopAverageOrderByWithRelationInputObjectSchema.array()]).optional(), where: TopAverageWhereInputObjectSchema.optional(), cursor: TopAverageWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TopAverageScalarFieldEnumSchema, TopAverageScalarFieldEnumSchema.array()]).optional() }).strict();