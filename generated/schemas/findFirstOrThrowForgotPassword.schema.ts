...
export const ForgotPasswordFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ForgotPasswordSelect> = z.object({
...
export const ForgotPasswordFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    user_id: z.boolean().optional(),
    code: z.boolean().optional(),
    claimed: z.boolean().optional(),
...
export const ForgotPasswordFindFirstOrThrowSchema: z.ZodType<Prisma.ForgotPasswordFindFirstOrThrowArgs> = z.object({ select: ForgotPasswordFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ForgotPasswordIncludeObjectSchema.optional()), orderBy: z.union([ForgotPasswordOrderByWithRelationInputObjectSchema, ForgotPasswordOrderByWithRelationInputObjectSchema.array()]).optional(), where: ForgotPasswordWhereInputObjectSchema.optional(), cursor: ForgotPasswordWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ForgotPasswordScalarFieldEnumSchema, ForgotPasswordScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ForgotPasswordFindFirstOrThrowArgs>;

export const ForgotPasswordFindFirstOrThrowZodSchema = z.object({ select: ForgotPasswordFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ForgotPasswordIncludeObjectSchema.optional()), orderBy: z.union([ForgotPasswordOrderByWithRelationInputObjectSchema, ForgotPasswordOrderByWithRelationInputObjectSchema.array()]).optional(), where: ForgotPasswordWhereInputObjectSchema.optional(), cursor: ForgotPasswordWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ForgotPasswordScalarFieldEnumSchema, ForgotPasswordScalarFieldEnumSchema.array()]).optional() }).strict();