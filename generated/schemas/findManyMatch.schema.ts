...
export const MatchFindManySelectSchema: z.ZodType<Prisma.MatchSelect> = z.object({
...
export const MatchFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    winner_id: z.boolean().optional(),
    created_at: z.boolean().optional(),
    link_code: z.boolean().optional(),
...
export const MatchFindManySchema: z.ZodType<Prisma.MatchFindManyArgs> = z.object({ select: MatchFindManySelectSchema.optional(), include: z.lazy(() => MatchIncludeObjectSchema.optional()), orderBy: z.union([MatchOrderByWithRelationInputObjectSchema, MatchOrderByWithRelationInputObjectSchema.array()]).optional(), where: MatchWhereInputObjectSchema.optional(), cursor: MatchWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MatchScalarFieldEnumSchema, MatchScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.MatchFindManyArgs>;

export const MatchFindManyZodSchema = z.object({ select: MatchFindManySelectSchema.optional(), include: z.lazy(() => MatchIncludeObjectSchema.optional()), orderBy: z.union([MatchOrderByWithRelationInputObjectSchema, MatchOrderByWithRelationInputObjectSchema.array()]).optional(), where: MatchWhereInputObjectSchema.optional(), cursor: MatchWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MatchScalarFieldEnumSchema, MatchScalarFieldEnumSchema.array()]).optional() }).strict();