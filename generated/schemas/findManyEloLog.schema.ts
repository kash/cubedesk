...
export const EloLogFindManySelectSchema: z.ZodType<Prisma.EloLogSelect> = z.object({
...
export const EloLogFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    opponent_id: z.boolean().optional(),
    cube_type: z.boolean().optional(),
    elo_change: z.boolean().optional(),
