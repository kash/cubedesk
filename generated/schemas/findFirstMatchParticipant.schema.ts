...
export const MatchParticipantFindFirstSelectSchema: z.ZodType<Prisma.MatchParticipantSelect> = z.object({
...
export const MatchParticipantFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    match_id: z.boolean().optional(),
    user_id: z.boolean().optional(),
    created_at: z.boolean().optional(),
...
export const MatchParticipantFindFirstSchema: z.ZodType<Prisma.MatchParticipantFindFirstArgs> = z.object({ select: MatchParticipantFindFirstSelectSchema.optional(), include: z.lazy(() => MatchParticipantIncludeObjectSchema.optional()), orderBy: z.union([MatchParticipantOrderByWithRelationInputObjectSchema, MatchParticipantOrderByWithRelationInputObjectSchema.array()]).optional(), where: MatchParticipantWhereInputObjectSchema.optional(), cursor: MatchParticipantWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MatchParticipantScalarFieldEnumSchema, MatchParticipantScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.MatchParticipantFindFirstArgs>;

export const MatchParticipantFindFirstZodSchema = z.object({ select: MatchParticipantFindFirstSelectSchema.optional(), include: z.lazy(() => MatchParticipantIncludeObjectSchema.optional()), orderBy: z.union([MatchParticipantOrderByWithRelationInputObjectSchema, MatchParticipantOrderByWithRelationInputObjectSchema.array()]).optional(), where: MatchParticipantWhereInputObjectSchema.optional(), cursor: MatchParticipantWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MatchParticipantScalarFieldEnumSchema, MatchParticipantScalarFieldEnumSchema.array()]).optional() }).strict();