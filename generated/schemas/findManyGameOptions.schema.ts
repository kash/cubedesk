...
export const GameOptionsFindManySelectSchema: z.ZodType<Prisma.GameOptionsSelect> = z.object({
...
export const GameOptionsFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    game_session_id: z.boolean().optional(),
    match_session_id: z.boolean().optional(),
    game_type: z.boolean().optional(),
