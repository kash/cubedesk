...
export const BadgeTypeFindFirstOrThrowSelectSchema: z.ZodType<Prisma.BadgeTypeSelect> = z.object({
...
export const BadgeTypeFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    priority: z.boolean().optional(),
    color: z.boolean().optional(),
...
export const BadgeTypeFindFirstOrThrowSchema: z.ZodType<Prisma.BadgeTypeFindFirstOrThrowArgs> = z.object({ select: BadgeTypeFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => BadgeTypeIncludeObjectSchema.optional()), orderBy: z.union([BadgeTypeOrderByWithRelationInputObjectSchema, BadgeTypeOrderByWithRelationInputObjectSchema.array()]).optional(), where: BadgeTypeWhereInputObjectSchema.optional(), cursor: BadgeTypeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BadgeTypeScalarFieldEnumSchema, BadgeTypeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.BadgeTypeFindFirstOrThrowArgs>;

export const BadgeTypeFindFirstOrThrowZodSchema = z.object({ select: BadgeTypeFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => BadgeTypeIncludeObjectSchema.optional()), orderBy: z.union([BadgeTypeOrderByWithRelationInputObjectSchema, BadgeTypeOrderByWithRelationInputObjectSchema.array()]).optional(), where: BadgeTypeWhereInputObjectSchema.optional(), cursor: BadgeTypeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BadgeTypeScalarFieldEnumSchema, BadgeTypeScalarFieldEnumSchema.array()]).optional() }).strict();