...
export const FriendshipRequestFindFirstOrThrowSelectSchema: z.ZodType<Prisma.FriendshipRequestSelect> = z.object({
...
export const FriendshipRequestFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    from_id: z.boolean().optional(),
    to_id: z.boolean().optional(),
    created_at: z.boolean().optional(),
