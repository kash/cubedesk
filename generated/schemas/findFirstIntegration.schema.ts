...
export const IntegrationFindFirstSelectSchema: z.ZodType<Prisma.IntegrationSelect> = z.object({
...
export const IntegrationFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    user_id: z.boolean().optional(),
    service_name: z.boolean().optional(),
    auth_token: z.boolean().optional(),
...
export const IntegrationFindFirstSchema: z.ZodType<Prisma.IntegrationFindFirstArgs> = z.object({ select: IntegrationFindFirstSelectSchema.optional(), include: z.lazy(() => IntegrationIncludeObjectSchema.optional()), orderBy: z.union([IntegrationOrderByWithRelationInputObjectSchema, IntegrationOrderByWithRelationInputObjectSchema.array()]).optional(), where: IntegrationWhereInputObjectSchema.optional(), cursor: IntegrationWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([IntegrationScalarFieldEnumSchema, IntegrationScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.IntegrationFindFirstArgs>;

export const IntegrationFindFirstZodSchema = z.object({ select: IntegrationFindFirstSelectSchema.optional(), include: z.lazy(() => IntegrationIncludeObjectSchema.optional()), orderBy: z.union([IntegrationOrderByWithRelationInputObjectSchema, IntegrationOrderByWithRelationInputObjectSchema.array()]).optional(), where: IntegrationWhereInputObjectSchema.optional(), cursor: IntegrationWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([IntegrationScalarFieldEnumSchema, IntegrationScalarFieldEnumSchema.array()]).optional() }).strict();