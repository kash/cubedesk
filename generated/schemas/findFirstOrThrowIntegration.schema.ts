...
export const IntegrationFindFirstOrThrowSelectSchema: z.ZodType<Prisma.IntegrationSelect> = z.object({
...
export const IntegrationFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    user_id: z.boolean().optional(),
    service_name: z.boolean().optional(),
    auth_token: z.boolean().optional(),
