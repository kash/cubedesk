...
export const CustomTrainerFindFirstOrThrowSelectSchema: z.ZodType<Prisma.CustomTrainerSelect> = z.object({
...
export const CustomTrainerFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    colors: z.boolean().optional(),
    cube_type: z.boolean().optional(),
    key: z.boolean().optional(),
...
export const CustomTrainerFindFirstOrThrowSchema: z.ZodType<Prisma.CustomTrainerFindFirstOrThrowArgs> = z.object({ select: CustomTrainerFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => CustomTrainerIncludeObjectSchema.optional()), orderBy: z.union([CustomTrainerOrderByWithRelationInputObjectSchema, CustomTrainerOrderByWithRelationInputObjectSchema.array()]).optional(), where: CustomTrainerWhereInputObjectSchema.optional(), cursor: CustomTrainerWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CustomTrainerScalarFieldEnumSchema, CustomTrainerScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CustomTrainerFindFirstOrThrowArgs>;

export const CustomTrainerFindFirstOrThrowZodSchema = z.object({ select: CustomTrainerFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => CustomTrainerIncludeObjectSchema.optional()), orderBy: z.union([CustomTrainerOrderByWithRelationInputObjectSchema, CustomTrainerOrderByWithRelationInputObjectSchema.array()]).optional(), where: CustomTrainerWhereInputObjectSchema.optional(), cursor: CustomTrainerWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CustomTrainerScalarFieldEnumSchema, CustomTrainerScalarFieldEnumSchema.array()]).optional() }).strict();