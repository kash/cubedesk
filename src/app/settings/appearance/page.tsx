...
import LayoutSelector from '../../../components/settings/appearance/layout_selector/LayoutSelector';
import TimerBackground from '../../../components/settings/appearance/timer_background/TimerBackground';
import SettingRow from '../../../components/settings/setting/row/SettingRow';
import Dropdown from '../../../components/common/inputs/dropdown/Dropdown';
import SettingSection from '../../../components/settings/setting/section/SettingSection';
import {setSetting} from '../../../lib/db/settings/update';
import {useSettings} from '../../../lib/util/hooks/useSettings';
import {Button} from '@/components/ui/button';
import ThemeOptions from '../../../components/settings/appearance/theme_options/ThemeOptions';
	...
	return (
		<>
			...
			<SettingRow title="Timer font" description="Font of the big timer you see on the timer page">
				...
				/>
				{timerFontFamily !== DEFAULT_FONT_FAMILY && (
					<Button
						variant="destructive"
						size="sm"
			...
			<SettingSection>
				<SettingRow title="Timer font size" description="Font size of the big time you see on the timer page">
					...
					/>
					{timerTimeSize !== getDefaultSetting('timer_time_size') && (
						<Button
							variant="destructive"
							size="sm"
			...
			<SettingSection>
				...
				>
					...
					/>
					{timerScrambleSize !== getDefaultSetting('timer_scramble_size') && (
						<Button
							variant="destructive"
							size="sm"
