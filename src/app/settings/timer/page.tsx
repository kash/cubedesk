...
import MicAccess from '../../../components/settings/mic_access/MicAccess';
import StackMatPicker from '../../../components/settings/stackmat_picker/StackMatPicker';
import {openModal} from '../../../lib/actions/general';
import CubeTypes from '../../../components/settings/cube_types/CubeTypes';
	...
	return (
		<>
			...
			<SettingRow loggedInOnly title="Cube Types" description="Add custom cube types with or without scrambles">
				<Button variant="secondary" onClick={toggleCubeTypes}>Manage Cube Types</Button>
			</SettingRow>
			<SettingRow
