...
import {fetchTrainerAlgorithmById} from '../../../../lib/db/trainer/query';
	...
	return (
		<div className={b()}>
			<div className={b('row')}>
				<h3>OLL</h3>
				<AlgoVisual
					colors={ollAlgo.colors}
					rotate={ollAlgo.rotate}
					cubeType={ollAlgo.cube_type}
				/>
				<p>{ollAlgo.name}</p>
			</div>
			<div className={b('row')}>
				<h3>PLL</h3>
				<AlgoVisual
					colors={pllAlgo.colors}
					rotate={pllAlgo.rotate}
					cubeType={pllAlgo.cube_type}
				/>
				<p>{pllAlgo.name}</p>
			</div>
		</div>
