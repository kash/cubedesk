...
import {ArrowCounterClockwise, ArrowsClockwise, Timer} from '@phosphor-icons/react/dist/ssr';
...
export default function StatsInfo(props: Props) {
	...
	const getStatCard = useCallback((icon: ReactNode, title: string, val: number | string) => {
		return (
