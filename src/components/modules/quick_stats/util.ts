...
import {getWorstTime} from '../../../lib/db/solves/stats/solves/single/single_worst';
...
import {getCubeTypeInfo} from '../../../lib/util/cubes/util';
...
export async function saveStatsModuleBlocks() {
	...
	await api.statsModule.update({ blocks });
}
