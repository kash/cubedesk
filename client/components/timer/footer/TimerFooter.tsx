...
export default function TimerFooter() {
	...
	let body = (
		<div
			className={classNames(
				'box-border h-[inherit] rounded-[15px] bg-module/80',
				timerLayout === 'bottom' &&
				...
				(timerLayout === 'left' || timerLayout === 'right') &&
					'grid !grid-cols-[1fr] !grid-rows-[repeat(3,minmax(0,1fr))] [@media(max-height:850px)]:!grid-rows-[repeat(2,minmax(0,1fr))] [@media(max-height:600px)]:!grid-rows-[repeat(1,minmax(0,1fr))]',
	...
	return (
		<div
			className={classNames(
				'box-border h-full px-[15px] pb-0 pt-0',
				(timerLayout === 'left' || timerLayout === 'right') && 'h-[calc(100vh_-_70px)] px-0 pb-2.5',
